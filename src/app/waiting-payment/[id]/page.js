        ...
        <Suspense fallback={<div>Loading...</div>}>
            <div>
                ...
                <div className="flex items-center border-[#F0F3F7] px-4 py-3 lg:hidden">
                    ...
                    <div className="ml-2 font-semibold">{t("orderDetail.detailPayment")}</div>
                </div>
                <div className="mx-auto min-h-screen max-w-7xl lg:flex">
                    ...
                    <div className="w-5/5 py-4 lg:w-4/5 lg:p-7 lg:px-4">
                        <div className="hidden items-center lg:flex">
                            ...
                            <div className="pb-1 text-2xl font-bold">{t("orderDetail.detailPayment")}</div>
                        </div>
                                ...
                                <div className="rounded-xl bg-white px-5 py-4 text-sm lg:shadow">
                                    ...
                                    {myInvoice && myInvoice?.payment_url && (
                                        <Link href={myInvoice?.payment_url}>
                                            <div className="my-2 cursor-pointer items-center justify-center rounded-lg bg-secondary px-6 py-3 text-center text-sm font-bold hover:bg-[#e8bc00]">{t("orderDetail.payNow")}</div>
                                        </Link>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="lg:w-1/2">
                                <div className="mb-4 rounded-xl bg-white px-5 py-4 lg:shadow">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <div className="ml-5 text-right text-sm leading-6">
                                            <label className="text-base font-bold">{order && order?.total?.formatted}</label>
                                        </div>
                                    </div>
                                </div>
