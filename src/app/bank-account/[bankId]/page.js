...
function BankAccountUpdate({ params }) {
    ...
    useEffect(() => {
        if (addressDetail) {
            ...
            if (addressDetail.latitude && addressDetail.longitude) {
                geocodeLatLng(addressDetail.latitude, addressDetail.longitude, setAddressMaps);
            }
        }
    }, [addressDetail]);
    ...
    return (
        <div>
                        ...
                        <div className="flex items-center justify-between rounded-lg border px-5 py-3 shadow">
                            <div className="flex items-center">
                                ...
                                <div className="w-full text-sm font-light">
                                    {selectedAddress === "" ? addressMaps : selectedAddress}
                                </div>
                            </div>
                            <div
                    ...
                    <form onSubmit={submitForm}>
                        <div className="items-center justify-between lg:mt-10 lg:flex">
                            <div className="item-center lg:w-5/12">
                                <div className="mb-1 font-semibold text-[#B1B1B1]">Label</div>
                                <input
                                    type="text"
                                    ...
                                    defaultValue={label}
                                />
                                <InputError messages={errors && errors.label} className={"mt-2"} />
                            </div>
                        </div>
                        <div className="mt-3 items-center justify-between lg:flex">
                            <div className="item-center lg:w-5/12">
                                <div className="mb-1 font-semibold text-[#B1B1B1]">Nama</div>
                                <input
                                    type="text"
                                    className="h-10 w-full rounded-lg border border-gray-300 p-2 focus:border-black focus:bg-[#0071850D] focus:ring-4 focus:ring-[#00D5FB33]"
                                    placeholder="Nama"
                        ...
                        <div className="mt-3 items-center justify-between lg:flex">
                            <div className="item-center lg:w-5/12">
                                <div className="mb-1 font-semibold text-[#B1B1B1]">Alamat</div>
                                <input
                                    type="text"
                                    className="h-10 w-full rounded-lg border border-gray-300 p-2 focus:border-black focus:bg-[#0071850D] focus:ring-4 focus:ring-[#00D5FB33]"
                                    placeholder="Alamat"
            ...
            {isShowMap && (
                <PopupAddress closePopup={() => setIsShowMap(false)} onSave={handleSaveAddress} />
            )}
