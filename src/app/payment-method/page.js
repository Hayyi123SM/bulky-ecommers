...
function PaymentMethod() {
    ...
    useEffect(() => {
        ...
        setSplitPaymentText(
            language === "en" ? "Split Payment with Friends" : "Bayar Patungan dengan Teman",
        );
    ...
    const handleSelectedFriend = (friend) => {
        if (!selectedFriend.some((i) => i.id === friend.id)) {
            setSelectedFriend([...selectedFriend, friend]);
        } else {
            const newValue = selectedFriend.filter((i) => i.id !== friend.id);
                        ...
                        <div className="h-fit w-full bg-white p-8 lg:max-w-xl lg:rounded-xl">
                            <div className="py-2">
                                ...
                                <div className="relative w-full lg:max-w-xl">
                                    ...
                                    <div
                                        className={`mt-1 w-full rounded-lg border border-[#F0F3F7] bg-white p-2 shadow-lg transition-all duration-300 ease-in-out ${isOpen ? "max-h-screen opacity-100" : "max-h-0 overflow-hidden opacity-0"}`}
                                    >
                                        <div
                                            className="flex cursor-pointer items-center border-b border-[#F0F3F7] p-2 text-sm hover:rounded-lg hover:bg-[#F5F5F5]"
                                            onClick={() => {
                                                handleOptionClick("/single.svg", "Bayar Langsung");
                        ...
                        >
                            ...
                            <div className="mt-0.5 flex h-fit w-full items-center justify-center rounded-b-xl bg-white px-4 py-2 lg:max-w-xl">
                                <div
                                    ...
                                    onClick={() => setIsOpenAddFriend(!isOpenAddFriend)}
                                >
                            ...
                            <div className="py-2">
                                <div className="relative w-full lg:max-w-xl">
                                    <div
                                        ...
                                        onClick={() => setIsOpenListFriend(!isOpenListFriend)}
                                    >
                                        <div className="flex items-center">
                                    ...
                                    <div
                                        className={`mt-1 w-full rounded-lg border border-[#F0F3F7] bg-white p-2 shadow-lg transition-all duration-300 ease-in-out ${isOpenListFriend ? "max-h-screen opacity-100" : "max-h-0 overflow-hidden opacity-0"}`}
                                    >
                                        <div className="flex cursor-pointer items-center border-b border-[#F0F3F7] p-2 text-sm hover:rounded-lg hover:bg-[#F5F5F5]">
                                            <input
                                                ...
                                                placeholder={t("other.searchYourFriend")}
                                                type="text"
                                            ...
                                            <div className="text-sm leading-6">
                                                <label className="text-sm font-light">
                                                    {Cookies.get("locale") === "en"
                                                        ? item.product?.name_trans?.en
                                                            ? item.product.name_trans.en
                                                            : item.product?.name_trans?.id
                                                        : item.product?.name_trans?.id}
                                                </label>
                                            </div>
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <div className="ml-5 text-right text-sm leading-6">
                                                    <label className="text-md font-light text-red-500">
                                                        - {item.discount_amount.formatted}
                                                    </label>
                                                </div>
                                            </div>
                                        )}
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        {cart.shipping_insurance.show && (
                                            <div className="flex items-center justify-between">
                                                ...
                                                >
                                                    {cart.shipping_insurance.formatted}
                                                </p>
                                            </div>
                                        )}
                                    </div>
                            ...
                            {cart.tax_enabled && (
                                <>
                                    <div className="flex justify-between">
                                        <div className="text-sm leading-6">
                                            <label className="text-sm font-light">
                                                PPN {cart.tax_rate.formatted}
                                            </label>
                                        </div>
                                        <div className="ml-5 text-right text-sm leading-6">
                                            <label className="text-md font-light">
                                                {cart.tax_amount.formatted}
                                            </label>
                                        </div>
                                    </div>
                                    <div className="my-5 border-b p-1" />
                            ...
                            <div className="flex justify-between">
                                ...
                                <div className="ml-5 text-right text-sm leading-6">
                                    <label className="text-lg font-bold">
                                        {isInsurance
                                            ? formatRupiah(cart.total.with_insurance)
