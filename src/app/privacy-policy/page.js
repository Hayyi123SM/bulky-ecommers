                    ...
                    <div className="lg:p-7">
                        <div className="items-center rounded-xl bg-white px-12 py-10 shadow">
                            ...
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                ...
                                Liquid8 and how we use it. If you have
                                additional questions or require more information
                                about our Privacy Policy, do not hesitate to
                                contact us.
                            </div>
                            <div className="text-2xl font-bold">Log Files</div>
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                Bulky follows a standard procedure of using log
                                files. These files log visitors when they visit
                                websites. All hosting companies do this and a
                                part of hosting services' analytics. The
                            ...
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                Like any other website, Bulky uses “cookies”.
                            ...
                            <div className="mb-4 mt-4 text-sm font-normal leading-6 opacity-80">
                                ...
                                advertisements and links that appear on Bulky,
                                which are sent directly to users' browser. They
                                automatically receive your IP address when this
                                occurs. These technologies are used to measure
                                the effectiveness of their advertising campaigns
                                and/or to personalize the advertising content
                                that you see on websites that you visit.
                            </div>
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                Note that Bulky has no access to or control over
                            ...
                            <div className="mb-4 mt-4 text-sm font-normal leading-6 opacity-80">
                                Bulky's Privacy Policy does not apply to other
                                advertisers or websites. Thus, we are advising
                                you to consult the respective Privacy Policies
                                of these third-party ad servers for more
                            ...
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                ...
                                the browsers' respective websites. What Are
                                Cookies?
                            </div>
                            <div className="text-2xl font-bold">
                            ...
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                Bulky does not knowingly collect any Personal
                                Identifiable Information from children under the
                                age of 13. If you think that your child provided
                                this kind of information on our website, we
                                strongly encourage you to contact us immediately
                                and we will do our best efforts to promptly
                            ...
                            <div className="mb-8 mt-4 text-sm font-normal leading-6 opacity-80">
                                ...
                                they shared and/or collect in Bulky. This policy
                                is not applicable to any information collected
                                offline or via channels other than this website.
                            </div>
                            <div className="text-2xl font-bold">Consent</div>
                            <div className="mb-4 mt-4 text-sm font-normal leading-6 opacity-80">
