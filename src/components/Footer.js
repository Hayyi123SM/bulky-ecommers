            ...
            <div className="flex flex-wrap font-normal text-[#212121]">
                <div className="w-full p-5 md:w-2/5 lg:w-3/12 xl:w-3/12">
                    ...
                    <div className="mt-3 flex text-sm">
                        ...
                        <div className="ml-2">
                            Jl. Raya Mayor Oking Jaya Atmaja No.62a, Kel Cirimekar, Kec. Cibinong,
                    ...
                    <div className="mt-3 flex text-sm">
                        ...
                        <div
                            ...
                            onClick={() => window.open("https://wa.me/62811833164", "_blank")}
                        >
                            0811 833 164
                        </div>
                    </div>
                ...
                <div className="w-1/3 p-5 md:w-1/5 lg:w-2/12 xl:w-2/12">
                    ...
                    <div className="mt-3 text-sm">Bogor</div>
                </div>
                <div className="w-1/3 p-5 md:w-1/5 lg:w-2/12 xl:w-2/12">
