            ...
            <div className={`relative flex flex-col rounded-lg border border-[#F0F3F7] bg-white p-1`}>
                ...
                <Link href={url}>
                    <div className="relative aspect-square w-full rounded-t-lg bg-cover bg-center" style={{ backgroundImage: `url(${image})` }}>
                        ...
                        {type && (
                            <div className="absolute bottom-0 left-0 flex items-center gap-2 bg-yellow-400 py-1 pl-2 pr-4 text-xs font-semibold [clip-path:polygon(0_0,100%_0,90%_100%,0_100%)]">
                                {type === "truck_load" && (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-3.5" viewBox="0 0 15 12" fill="none">
                                        <path
                                ...
                                {type === "palet" && (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-3.5" viewBox="0 0 15 15" fill="none">
                                        <path
                ...
                <div className="h-[180px] flex-grow px-1 py-4">
                    <Link href={url}>
                        <div className="py-1 text-xs font-bold text-[#007185]">{location}</div>
