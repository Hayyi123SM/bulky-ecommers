    ...
    return (
        <div className="hidden w-1/5 lg:block">
            ...
            <div className="border-b py-2">
                ...
                {/* {showFilterCategories && ( */}
                <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilterCategories && showAllCategories ? "max-h-full opacity-100" : showFilterCategories ? "max-h-32 overflow-y-auto opacity-100" : "max-h-0 opacity-0"}`}
                >
                    {loadingFilters ? (
                        <Skeleton count={3} />
                    ) : (
            ...
            <div className="border-b py-2">
                ...
                {/* {showFilterBrands && ( */}
                <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilterBrands && showAllBrands ? "max-h-full opacity-100" : showFilterBrands ? "max-h-32 overflow-y-auto opacity-100" : "max-h-0 opacity-0"}`}
                >
                    {loadingFilters ? (
                        <Skeleton count={3} />
                    ) : (
            ...
            <div className="border-b py-2">
                ...
                {/* {showFilterWarehouses && ( */}
                <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilterWarehouses && showAllWarehouses ? "max-h-full opacity-100" : showFilterWarehouses ? "max-h-32 overflow-y-auto opacity-100" : "max-h-0 opacity-0"}`}
                >
                    {loadingFilters ? (
                        <Skeleton count={3} />
                    ) : (
            ...
            <div className="border-b py-2">
                ...
                {/* {showFilterConditions && ( */}
                <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilterConditions && showAllConditions ? "max-h-full opacity-100" : showFilterConditions ? "max-h-32 overflow-y-auto opacity-100" : "max-h-0 opacity-0"}`}
                >
                    {loadingFilters ? (
                        <Skeleton count={3} />
                    ) : (
            ...
            <div className="border-b py-2">
                ...
                {/* {showFilterStatuses && ( */}
                <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilterStatuses && showAllStatuses ? "max-h-full opacity-100" : showFilterStatuses ? "max-h-32 overflow-y-auto opacity-100" : "max-h-0 opacity-0"}`}
                >
                    {loadingFilters ? (
                        <Skeleton count={3} />
                    ) : (
