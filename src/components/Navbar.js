...
function Navbar({ togglePopupMenu, visibleOn = "both" }) {
    ...
    const visibilityClasses =
        visibleOn === "mobile" ? "lg:hidden" : visibleOn === "desktop" ? "hidden lg:block" : ""
                    ...
                    <div className="mx-auto max-w-7xl px-5 py-3">
                                                ...
                                                <ul className="py-2">
                                                    {searchResults && searchResults.length > 0 ? (
                                                        searchResults.map((product) => (
                                                            <li
                                                                key={product.id}
                                                                className="m-2 flex cursor-pointer items-center justify-between px-4 py-2 hover:rounded-lg hover:bg-[#F0F3F7]"
                                                                onMouseDown={(e) =>
                                                                    e.preventDefault()
                                                                }
                                                                onClick={() =>
                        ...
                        <div className="mt-4 flex items-center text-sm">
                            ...
                            <div className="flex w-7/12 items-center justify-between">
                                <Link href="/">
                                    <div className="cursor-pointer px-8 text-white hover:text-secondary">
                                        {t("navbar.home")}
                                    </div>
                                </Link>
                                <Link
